...
class DashboardAluno(ctk.CTkToplevel):
    def __init__(self, usuario):
        ...
        self.create_sidebar_button("📅  Minhas Turmas", self.show_turmas, 3)
    ...
    def show_home(self):
        self.clear_main()
        ctk.CTkLabel(self.main_frame, text="Bem-vindo(a), Aluno!", font=self.title_font, text_color=COLORS["text_dark"]).grid(row=0, column=0, columnspan=3, pady=(20, 30))
        self.create_card(1, 0, "📚 Atividades", "5 Pendentes")
        self.create_card(1, 1, "🏫 Turmas", "2 Ativas")
    ...
    def show_atividades(self):
        self.clear_main()
        ctk.CTkLabel(self.main_frame, text="Minhas Atividades", font=self.title_font, text_color=COLORS["text_dark"]).pack(pady=50)
    ...
    def show_desempenho(self):
        self.clear_main()
        ctk.CTkLabel(self.main_frame, text="Meu Desempenho", font=self.title_font, text_color=COLORS["text_dark"]).pack(pady=50)
